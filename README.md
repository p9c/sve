...
Sve is an experimental library for web UIs written in Go and targeting webassembly.  Guide and docs at https://www.sve.org.
...
Introducing Sve (pronounced /ˈvuː.ɡuː/), a VueJS-inspired library in Go targeting wasm.
...
* 2019-09-07 Updated everything for Go 1.13, including both master and component-refactor branches, Sve's js wrapper package, site documentation.
...
* 2019-08-25 CSS now supported on component-refactor branch, including in full-HTML mode, working sample that pulls in Bootstrap CSS.  Sve's [js wrapper package](https://godoc.org/github.com/p9c/sve/js) copied to master and made available.
...
* 2019-07-20 Some design info on how "data binding" (hashing actually) will work in Sve: https://github.com/p9c/sve/wiki/Data-Hashing-vs-Binding
* 2019-07-16 Sve has a logo! https://www.instagram.com/p/Bz3zmtYAYcM/  Good things are in the works, the plan is to get a bunch of much-awaited updates pushed to master before the end of the month.
...
* 2019-04-07 The Sve Playground is up at: https://play.sve.org/
...
Get started: http://www.sve.org/doc/start
...
It's built **more like a library than a framework**.  While Sve does do code generation for your .sve component
...
Frameworks call your code.  Sve is a library, your code calls it (even if Sve generates a bit of that for you in
the beginning to make things easier). One of the primary goals for Sve, when it comes to developers first encountering it, 
...
via `go generate`. There are many small decisions in Sve which follow this philosophy: wherever reasonably possible,
just use the existing mechanism instead of inventing anew.  And keep doing that until there's proof that something
else is really needed.  So far it's been working well.  And it allows Sve to focus on the specific things it 
brings to the table.
