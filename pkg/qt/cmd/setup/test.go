...
import (
	...
	"github.com/p9c/sve/pkg/qt/cmd/deploy"
	"github.com/p9c/sve/pkg/qt/cmd/minimal"
	"github.com/p9c/sve/pkg/qt/cmd/moc"
	"github.com/p9c/sve/pkg/qt/cmd/rcc"
...
func Test(target string, docker, vagrant bool, vagrantsystem string) {
	...
	for cat, list := range examples {
		for _, example := range list {
			...
			path := filepath.Join(strings.TrimSpace(utils.GoListOptional("{{.Dir}}", "github.com/p9c/sve/pkg/qt/examples", "-find", "get doc dir")), example)
