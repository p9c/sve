...
[Gallery](https://github.com/p9c/sve/pkg/qt/wiki/Gallery) of example applications making use of this package.
...
##### Windows [(more info)](https://github.com/p9c/sve/pkg/qt/wiki/Installation-on-Windows)

```powershell
set GO111MODULE=off
go get -v github.com/p9c/sve/pkg/qt/cmd/... && for /f %v in ('go env GOPATH') do %v\bin\qtsetup test && %v\bin\qtsetup -test=false
```

##### macOS [(more info)](https://github.com/p9c/sve/pkg/qt/wiki/Installation-on-macOS)

```bash
export GO111MODULE=off; xcode-select --install; go get -v github.com/p9c/sve/pkg/qt/cmd/... && $(go env GOPATH)/bin/qtsetup test && $(go env GOPATH)/bin/qtsetup -test=false
```

##### Linux [(more info)](https://github.com/p9c/sve/pkg/qt/wiki/Installation-on-Linux)

```bash
export GO111MODULE=off; go get -v github.com/p9c/sve/pkg/qt/cmd/... && $(go env GOPATH)/bin/qtsetup test && $(go env GOPATH)/bin/qtsetup -test=false
```

Resources
---------

-	[General Installation](https://github.com/p9c/sve/pkg/qt/wiki/Installation)
-	[Getting Started](https://github.com/p9c/sve/pkg/qt/wiki/Getting-Started)
-	[Wiki](https://github.com/p9c/sve/pkg/qt/wiki)
-	[Qt Documentation](https://doc.qt.io/qt-5/classes.html)
-	[FAQ](https://github.com/p9c/sve/pkg/qt/wiki/FAQ)
