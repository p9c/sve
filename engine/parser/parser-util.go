...
func attrFromHtml(attr html.Attribute) vnode.VGAttribute {
	return vnode.VGAttribute{
...
// func attrFromHtmlx(attr htmlx.Attribute) vnode.VGAttribute {
// 	return vnode.VGAttribute{
// 		Namespace: attr.Namespace,
// 		Key:       attr.Key,
// 		Val:       attr.Val,
...
func staticVGAttr(inAttr []html.Attribute) (ret []vnode.VGAttribute) {
...
// func staticVGAttrx(inAttr []htmlx.Attribute) (ret []vnode.VGAttribute) {
